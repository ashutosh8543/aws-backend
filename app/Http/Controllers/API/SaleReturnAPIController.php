...
class SaleReturnAPIController extends AppBaseController
{
    ...
    {
        $salesReturn = $salesReturn->load('saleReturnItems', 'warehouse', 'customer','customer.channelDetails','salesmanDetails','salesmanDetails.areaDetails');
        $keyName = [
    ...
    {  
        ...
        $saleReturn = $saleReturn->load('saleReturnItems', 'warehouse', 'customer','salesmanDetails','salesmanDetails.areaDetails');
        $data = [];
    ...
    public function getSaleReturnProductReport(Request $request): SaleReturnCollection
    {
        ...
        $saleReturns = $this->saleReturnRepository->whereHas('saleReturnItems', function ($q) use ($productId,$warehouse_id) {
            $q->where('product_id', '=', $productId)
            ->where('warehouse_id', '=', $warehouse_id);
        })->with(['saleReturnItems', 'warehouse', 'customer','salesmanDetails','salesmanDetails.areaDetails']);
    ...
    public function getProductReturnSaleReport(Request $request): SaleReturnCollection
    {
        $perPage = getPageSize($request);
        $productId = $request->get('product_id');
