...
class SaleReturn extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'sales' => $this->saleDetails($this->sale_id),
            'customer_id' => $this->customer_id,
            'customer_name' => $this->customer->name,
            'customer_email' => $this->customer->email,
            'customer_phone' => $this->customer->phone,
            'customer_area' => $this->customerArea($this->customer_id),
            'customer_chanel_name' => $this->customerChanel($this->customer_id),
            ...
            'salesmanDetails'=>$this->salesmanDetails,
    ...
    public function customerChanel($id){
        
        $customer= Customer::find($id);
        return $chaneldetails = Chanel::find($customer->chanel_id)->name??'';
       
   }
   public function customerArea($id){
        
    $customer= Customer::find($id);
    return $chaneldetails = Area::find($customer->area_id)->name??'';
