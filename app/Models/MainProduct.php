...
{
    use SoftDeletes, HasFactory, HasJsonResourcefulData, InteractsWithMedia;
   ...
   public function salesmanStock(){
     return $this->hasMany(SalesmanStock::class,'product_id','id');
   }
