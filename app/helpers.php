...
if (!function_exists('create_notification')) {
    /**
     * Create a notification and store it in the custom table.
     *
     * @param int $userId
     * @param string $title
     ...
     */
    function create_notification($salesmanId=null,$distributorId=null,$warehouseId=null,$title=null,$content=null)
    {   
        $noti=   new Notification();
        $noti->salesman_id= $salesmanId;
        $noti->is_read= 0;
        $noti->distributor_id= $distributorId;
        $noti->warehouse_id= $warehouseId;
        $noti->subject=$title;
